      ...
      <div className="relative z-10 max-w-5xl xl:max-w-6xl mx-auto px-4 sm:px-6 w-full">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-4">
            <FragmentReveal delay={0.1} from="left">
              <CardPitch accentColor="#a78bfa">
                <h3 className="text-[var(--foreground)] font-bold text-sm mb-4">
                  DTPMP — Dai Table 2 Grid Search
                </h3>
                <div className="grid grid-cols-2 gap-x-4 gap-y-4">
                  <div className="flex flex-col">
                    <span className="text-3xl font-black tracking-tight stat-gradient">8</span>
                    <p className="text-[var(--muted-foreground)] text-[0.65rem] font-medium uppercase tracking-wider mt-0.5">
                      Data Points
                    </p>
                  </div>
                  <div className="flex flex-col">
            ...
            <FragmentReveal delay={0.2} from="left">
              <CardPitch>
                <h3 className="text-[var(--foreground)] font-bold text-sm mb-4">Calibration Results</h3>
                <div className="flex flex-col gap-3">
                  <div className="flex items-center justify-between py-1.5 border-b border-[var(--border)]">
                    <span className="text-[var(--muted-foreground)] text-xs font-medium">K</span>
                    <span className="font-mono text-sm font-bold text-[var(--foreground)]">5.0 ppm⁻¹</span>
                  </div>
                  <div className="flex items-center justify-between py-1.5 border-b border-[var(--border)]">
                    <span className="text-[var(--muted-foreground)] text-xs font-medium">α</span>
                    <span className="font-mono text-sm font-bold text-[var(--foreground)]">0.040</span>
                  </div>
                  <div className="flex items-center justify-between py-1.5 border-b border-[var(--border)]">
                    <span className="text-[var(--muted-foreground)] text-xs font-medium">RMSE</span>
                  ...
                  <div className="flex items-center justify-between pt-1">
                    <span className="text-[var(--muted-foreground)] text-xs font-medium">Improvement</span>
          ...
          <FragmentReveal delay={0.15} from="right">
            <CardPitch>
              <h3 className="text-[var(--foreground)] font-bold text-sm mb-3">
              ...
              <p className="text-[var(--muted-foreground)] text-[0.6rem] italic text-center">
